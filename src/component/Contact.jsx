...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative bg-gradient-to-b from-gray-900 via-gray-800 to-black py-20 px-6 scroll-mt-24"
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16">
        ...
        <motion.form
          ...
          whileInView="show"
          viewport={{ once: false, amount: 0.3 }}
          className="w-full md:w-1/2 p-10 rounded-2xl bg-white/10 backdrop-blur-md border border-red-300/30 shadow-lg shadow-red-500/20 hover:shadow-red-400/40 transition duration-300"
        >
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-lg bg-gradient-to-r from-red-500 to-pink-500 text-white font-semibold text-lg hover:scale-[1.02] hover:shadow-lg hover:shadow-red-400/40 transition-transform duration-300"
          >
            Send Message
          </button>
